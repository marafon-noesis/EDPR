...
(function () {
    ...
    if (typeof MobileCRM === "undefined") {
        MobileCRM = {
            ...
            /// <field name="bridge" type="MobileCRM.Bridge">Singleton instance of <see cref="MobileCRM.Bridge">MobileCRM.Bridge</see> providing the management of the Javascript/C# cross-calls.</field>
            bridge: null,
            ...
            Reference: function (entityName, id, primaryName) {
                /// <summary>This object represents an entity reference which provides the minimum information about an entity.</summary>
            ...
            Relationship: function (sourceProperty, target, intersectEntity, intersectProperty) {
                /// <summary>An object which represents a relationship between two entities.</summary>
            ...
            DynamicEntity: function (entityName, id, primaryName, properties, isOnline) {
                /// <summary>This object represents a CRM entity, with only a subset of properties loaded.</summary>
            ...
            MetaEntity: function (props) {
                /// <summary>This object represents an entity metadata.</summary>
                MobileCRM.MetaEntity.superproto.constructor.apply(this, arguments);
            },

            MetaProperty: function () {
                /// <summary>This object represents a property (CRM field) metadata.</summary>
            ...
            FetchXml: {
                Fetch: function (entity, count, page) {
                    ...
                    /// <field name="aggregate" type="int">Indicates whether the fetch is aggregated.</field>
            ...
            UI: {
                ...
                ReportForm: function () {
                    /// <summary>[v8.1] Represents the report form object.</summary>
                ...
                LookupForm: function () {
                    /// <summary>This object allows the user to select an entity from a configurable list of entity types.</summary>
        ...
        MobileCRM.AboutInfo.requestObject = function (callback, errorCallback, scope) {
            /// <summary>[v8.2] Get About Info</summary>
        ...
        MobileCRM.Bridge.prototype.enableDebug = function (callback, errorCallback, scope) {
            ...
            /// <param name="errorCallback" type="function(errorMsg)">The errorCallback which is called asynchronously in case of error.</param>
            /// <param name="scope" type="Object">The scope for callbacks.</param>
            /// <remarks><p>After calling this method, it is possible to attach the Google Chrome debugger into the web page opened in MobileCRM application running on Android 4.4 KitKat. This functionality is not available on older Androids.</p><p>This method also activates the Javascript warnings on windows 7 app version.</p><p>Refer to the JSBridge Guide for further details.</p></remarks>
        ...
        MobileCRM.Bridge.prototype.log = function (text) {
            /// <summary>[v8.0] Types the message into JSBridge log.</summary>
        ...
        MobileCRM.MetaEntity.loadByName = function (name, callback, errorCallback, scope) {
            /// <summary>Gets the MetaEntity by its name.</summary>
            /// <param name="name" type="String">A name of entity.</param>
        ...
        MobileCRM.UI.LookupForm.prototype.addEntityFilter = function (entityName, filterXml) {
            ...
            /// <param name="entityName" type="string">Entity logical name.</param>
            /// <param name="viewName" type="string">A string defining the fetch XML which has to be applied as filter for entity records.</param>
            if (!this._filters)
                this._filters = {};
        ...
        MobileCRM.UI.LookupForm.prototype.show = function (success, failed, scope) {
            ...
            if (obsoleteFilters && this.entities.length > 0)
                xml += "<filter entity='" + this.entities[0] + "'>" + _escape(filter) + "</filter>";

            xml += "</extra>";
            var params = { entities: this.entities, source: this.source, prevSelection: this.prevSelection, allowedViews: xml, allowNull: this.allowNull };
            MobileCRM.bridge.command("lookupForm", JSON.stringify(params), success, failed, scope);
        };
        ...
        MobileCRM.UI.EntityForm._handlers = { onChange: [], onSave: [], onPostSave: [], onDetailCollectionChange: [] };
        ...
        MobileCRM.UI.EntityForm.enableCommand = function (command, enable) {
    ...
    String.prototype.toJSON = function () {
      ...
      Mobile.Sdk.core.execute = function (functionName) {
 ...
 //     			}
      	...
      	// Don't TRACE the 'log' method, otherwise it will result in infinite loop.
      	if (Mobile.Sdk.TRACE && (args.length === 0 || args[0] != "log")) {
      		Mobile.Sdk.core.logger.log("Mobile.Sdk.core.execute: " + JSON.stringify(args));
      	}

      	// This line is used for unit testing the sdk and needs to be commented out or removed when used for your platform.
      	////console.log("execute(): " + JSON.stringify(args));

      	//return WP7Bridge.callNative(args);

      	return MobileCRM.bridge.invoke("cwrcall", JSON.stringify(args));
      }